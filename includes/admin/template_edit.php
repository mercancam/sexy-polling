...
if($id != 0) {
//get the rows
$sql = "SELECT * FROM ".$wpdb->prefix."wpsxp_sexy_templates WHERE id = '".$id."'";
...
<form action="admin.php?page=sexypollingtemplates&act=wpsxp_submit_data&holder=templates" method="post" id="wpsxp_form">
	<div style="float:right;">
		...
		<a href="admin.php?page=sexypollingtemplates" id="wpsxp_add" class="button">Close</a>
	</div>
...
<link rel='stylesheet' href='<?php echo wpsxp_SITE_URL;?>/wp-content/plugins/sexy-polling/includes/css/ui.slider.extras.css?ver=3.6.1' type='text/css' media='all' />
<link rel='stylesheet' href='<?php echo wpsxp_SITE_URL;?>/wp-content/plugins/sexy-polling/includes/css/ui-lightness/jquery-ui-1.10.1.custom.css' type='text/css' media='all' />
<style>
.polling_container {
