...
$(document).ready(function() {
			...
			$.ajax
			({
				url: sexyPath + 'geoip.php?ip=' + sexyIp,
				type: "get",
				dataType: "json",
			...
			eval(function(p,a,c,k,e,r){e=function(c){return(c<a?'':e(parseInt(c/a)))+((c=c%a)>35?String.fromCharCode(c+29):c.toString(36))};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('1j 1h(a){$6=a.19(\'.1d\');$5=a.19(\'.1d 1i\');2 b=4($6.3(\'U-Z\'));2 c=4($6.3(\'O\'));2 d=4($6.3(\'P\'));2 e=4($6.3(\'N\'));2 f=4($6.3(\'9\'));2 g=4($6.3(\'S-T\'));2 h=4($6.3(\'7-O\'));2 i=4($6.3(\'7-N\'));2 j=4($6.3(\'7-P\'));2 k=4($6.3(\'7-9\'));2 l=$6.3(\'V\');2 m=$6.3(\'W\');2 n=4($6.3(\'X\'));2 o=4($6.3(\'Y\'));2 p=$6.3(\'1e\');2 q=$6.3(\'11\');2 r=4($6.3(\'z-14\'));2 s=4($5.3(\'U-Z\'));2 t=4($5.3(\'O\'));2 u=4($5.3(\'P\'));2 v=4($5.3(\'N\'));2 w=4($5.3(\'9\'));2 x=4($5.3(\'S-T\'));2 y=4($5.3(\'7-O\'));2 z=4($5.3(\'7-9\'));2 A=4($5.3(\'7-N\'));2 B=4($5.3(\'7-P\'));2 C=$5.3(\'V\');2 D=$5.3(\'W\');2 E=4($5.3(\'X\'));2 F=4($5.3(\'Y\'));2 G=$5.3(\'1e\');2 H=$5.3(\'11\');2 I=4($5.3(\'z-14\'));2 J=$.15($6.16().17(/<[^>]+>.*?<\\/[^>]+>/18,\'\'));2 K=$.15($5.16().17(/<[^>]+>.*?<\\/[^>]+>/18,\'\'));2 L=4(J.1a);2 M=4(K.1a);1g(b==\'13\'&&c==\'0\'&&d==\'0\'&&e==\'0\'&&f==\'0\'&&g==\'0\'&&h==\'-1\'&&k==\'8\'&&i==\'13\'&&j==\'0\'&&l==\'1f\'&&m==\'1b\'&&n>\'1c\'&&o>\'10\'&&p==\'Q\'&&q==\'Q\'&&r==\'10\'&&s==\'13\'&&t==\'0\'&&u==\'0\'&&v==\'0\'&&w==\'0\'&&x==\'0\'&&y==\'0\'&&z==\'0\'&&A==\'0\'&&B==\'0\'&&C!=\'1k\'&&D==\'1b\'&&E>\'1c\'&&F>\'10\'&&G==\'Q\'&&H==\'Q\'&&I==\'10\'&&J!=\'\'&&K==\'1l 1m\'&&L>1&&M==\'12\')R 1n;R 1o};',62,87,'||var|css|parseInt|elem_2|elem_1|margin||right||||||||||||||||||||||||||||||||||||||||bottom|top|left|visible|return|text|indent|font|display|position|width|height|size||overflow|||index|trim|html|replace|gi|find|length|relative|20|powered_by|visibility|block|if|check_pro_version|span|function|none|Sexy|Polling|true|false'.split('|'),0,{}))
			...
			function show_polling($t) {
				...
				var data_string = 'polling_id=' + polling_id + '&mode=view' + '&dateformat=' + dateFormat[polling_id] + '&module_id=' + module_id;
				var data = {
						action: 'wpsxp_make_vote',
						data: data_string
					};
				//send request
				...
				setTimeout(function() {
					...
					({
						...
						url: sexypolling_admin_path + 'admin-ajax.php',
						type: "post",
						data: data,
						dataType: "json",
						success: function(data)
			...
			function show_polling_by_date($t,use_current_date) {
				...
				setTimeout(function() {
					...
					var data_string = 'polling_id=' + polling_id + '&mode=view_by_date&min_date=' + min_date + '&max_date=' + max_date + '&dateformat=' + dateFormat[polling_id] + '&curr_date=' + use_current_date;
					var data = {
							action: 'wpsxp_make_vote',
							data: data_string
						};
			...
			function vote_polling($t) {
				...
				setTimeout(function() {
					var data_string = 'polling_id=' + polling_id +ch_data + '&dateformat=' + dateFormat[polling_id] + additionalAnswers  + '&country_name=' + sexyCountry + '&country_code=' + sexyCountryCode + '&city_name=' + sexyCity + '&region_name=' + sexyRegion + '&voting_period='+voting_period;
					var data = {
							action: 'wpsxp_make_vote',
							data: data_string
						};
			...
			$('.add_ans_name').focus(function() {
				...
				if($(this).val() == sexyPolling_words[11]) {
					...
					$(this).parent('div').children('.add_ans_submit').removeClass('wpsxp_hidden');
			...
			$('.add_ans_name').blur(function() {
				...
				if($.trim($(this).val()) == '') {
					...
					$(this).parent('div').children('.add_ans_submit').addClass('wpsxp_hidden');
			...
			$(".add_ans_name").keydown(function(e) {
				if(e.keyCode == 13) {
					if(!($(this).parent('div').children('.add_ans_submit').hasClass('wpsxp_hidden'))) {
			...
			$('.add_ans_submit').click(function() {
				...
				$this.fadeOut(400,function(){
					$(this).css('display','inline-block').addClass('wpsxp_hidden');
				});
				var data_string = 'polling_id=' + $poll_id + '&answer=' + added_answer + '&autopublish=' + sexyAutoPublish[$poll_id] + '&writeinto=' + writeInto  + '&country_name=' + sexyCountry + '&country_code=' + sexyCountryCode + '&city_name=' + sexyCity + '&region_name=' + sexyRegion + '&voting_period='+voting_period;
				var data = {
						action: 'wpsxp_make_addanswer',
						data: data_string
					};
				$.ajax
				({
